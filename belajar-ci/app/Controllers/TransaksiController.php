...
class TransaksiController extends BaseController
{
    ...
    { 
        ...
        $ongkir = (double) $this->request->getPost('ongkir');
        $kupon = strtoupper(trim($this->request->getPost('kupon_code')));

        $diskon = hitung_diskon_kupon($subtotal, $kupon);
        $ppn = hitung_ppn($subtotal);
        $biayaAdmin = hitung_biaya_admin($subtotal);

        $grandTotal = $subtotal - $diskon + $ppn + $biayaAdmin + $ongkir;
